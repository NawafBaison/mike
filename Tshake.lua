...
if text == (database:get(bot_id.."Tshake:Name:Bot") or "مايك") then
Namebot = (database:get(bot_id.."Tshake:Name:Bot") or "مايك")
local namebot = {
...
download_to_file('https://raw.githubusercontent.com/NawafBaison/mike/main/Tshake.lua', 'Tshake.lua') 
download_to_file('https://raw.githubusercontent.com/NawafBaison/mike/main/start.lua', 'start.lua') 
dofile('Tshake.lua')  
return false
end
...
🧸┇MIKE
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
📊┇ [SADNESSl](https://t.me/lMllMll)

📋┇ [ترتيب انستا](https://t.me/iiib6s)


🌐┇ [MIKEY](https://t.me/X_MIKEY)
 
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
📧┇ [TWS MiKeY](https://t.me/TMS5_BOT)
]]
send(msg.chat_id_, msg.id_,Text)
end
...
local Name_Bot = (database:get(bot_id.."Tshake:Name:Bot") or "مايك")
